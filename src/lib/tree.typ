...
/// ==== Nodes
///
/// A tree node is an array consisting of the nodes value at index $0$ followed by its
/// child nodes. For the default `draw-node` function, the value (first item) of
/// an node must be of type `<content>`.
///
