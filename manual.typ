...
#doc-style.show-parameter-block("post-transform", "bool", [If true, place marks post path transformation, which results in marks not affected by the current transformation.], default: false)
