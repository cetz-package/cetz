...
#doc-style.show-parameter-block("shape-transform", "bool", [If false, place marks post path transformation, which results in marks not affected by the current transformation.], default: true)
